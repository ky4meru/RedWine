...
Start-ChocolateyProcessAsAdmin -ExeToRun "C:\Windows\system32\Dism.exe" -Statements "/Online /Enable-Feature /FeatureName:NetFx3 /All /NoRestart" -ValidExitCodes @(0, 3010)